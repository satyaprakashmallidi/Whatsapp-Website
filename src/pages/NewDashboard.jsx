    ...
    <PageLoader delay={400}>
      <div className="p-4 lg:p-8">
        ...
        <div className="mb-6 lg:mb-8">
          ...
          <p className="text-sm lg:text-base text-gray-600">Overview of your WhatsApp campaign performance</p>
        </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 mb-8">
          <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl shadow-md p-6 border border-blue-200 hover:shadow-lg transition-shadow">
            <div className="flex items-start justify-between mb-4">
              <div>
                <p className="text-xs lg:text-sm font-medium text-blue-700 mb-1">Total Contacts</p>
                <p className="text-2xl lg:text-3xl font-bold text-blue-900">{stats.totalContacts}</p>
              </div>
            ...
            <p className="text-[10px] lg:text-xs text-blue-600">📈 Growing audience</p>
          </div>
          ...
          <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-xl shadow-md p-6 border border-yellow-200 hover:shadow-lg transition-shadow">
            <div className="flex items-start justify-between mb-4">
              <div>
                <p className="text-xs lg:text-sm font-medium text-yellow-700 mb-1">Campaigns</p>
                <p className="text-2xl lg:text-3xl font-bold text-yellow-900">{stats.totalCampaigns}</p>
              </div>
              <div className="w-10 h-10 lg:w-12 lg:h-12 bg-yellow-500 rounded-lg lg:rounded-xl flex items-center justify-center shadow-lg">
                <svg className="w-5 h-5 lg:w-6 lg:h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8" />
                </svg>
              </div>
            </div>
            <p className="text-[10px] lg:text-xs text-yellow-600">🎯 {stats.sentCampaigns} sent • {stats.draftCampaigns} draft</p>
          </div>
          ...
          <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl shadow-md p-6 border border-green-200 hover:shadow-lg transition-shadow">
            <div className="flex items-start justify-between mb-4">
              <div>
                <p className="text-xs lg:text-sm font-medium text-green-700 mb-1">Templates</p>
                <p className="text-2xl lg:text-3xl font-bold text-green-900">{stats.totalTemplates}</p>
              </div>
              <div className="w-10 h-10 lg:w-12 lg:h-12 bg-green-500 rounded-lg lg:rounded-xl flex items-center justify-center shadow-lg">
                <svg className="w-5 h-5 lg:w-6 lg:h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
              </div>
            </div>
            <p className="text-[10px] lg:text-xs text-green-600">📝 Ready to use</p>
          </div>
          ...
          <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl shadow-md p-6 border border-purple-200 hover:shadow-lg transition-shadow">
            <div className="flex items-start justify-between mb-4">
              <div>
                <p className="text-xs lg:text-sm font-medium text-purple-700 mb-1">Messages Sent</p>
                <p className="text-2xl lg:text-3xl font-bold text-purple-900">{stats.messagesSent}</p>
              </div>
              <div className="w-10 h-10 lg:w-12 lg:h-12 bg-purple-500 rounded-lg lg:rounded-xl flex items-center justify-center shadow-lg">
                <svg className="w-5 h-5 lg:w-6 lg:h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <p className="text-[10px] lg:text-xs text-purple-600">✉️ All time total</p>
          </div>
        </div>
                ...
                {recentCampaigns.map((campaign) => (
                  <div key={campaign.id} className="p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer" onClick={() => navigate('/campaigns')}>
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className={`px-2 py-1 text-xs font-medium rounded ${campaign.status === 'Sent'
