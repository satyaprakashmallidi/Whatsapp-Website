      ...
      <div className="flex-1 flex items-center justify-center px-4 py-6">
        <div className="w-full max-w-sm bg-white rounded-2xl shadow-lg border border-gray-100 p-7">
          <div className="mb-6">
            ...
            <p className="text-gray-500 text-sm mt-1">Sign in to manage your campaigns</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex justify-between mb-1.5">
                <label className="block text-gray-700 font-semibold text-xs tracking-wide uppercase">
                  Password
                </label>
                <button type="button" className="text-amber-600 hover:text-amber-700 font-semibold text-xs transition-colors">
                  Forgot?
                </button>
              </div>
