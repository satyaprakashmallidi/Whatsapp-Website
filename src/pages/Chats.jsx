      ...
      <div className="h-full bg-white rounded-xl shadow-sm overflow-hidden flex">
              ...
              conversationList.map(({ contact, lastMessage, lastMessageTime, unread }) => (
                <div
                  ...
                  className={`p-4 border-b border-gray-100 cursor-pointer hover:bg-gray-50 transition-colors ${
                    selectedContact?.id === contact.id ? 'bg-[#F5F5F5]' : ''
                  }`}
                >
        ...
        <div className="flex-1 flex flex-col min-h-0">
          {selectedContact ? (
            <>
              {/* Chat Header */}
              <div className="p-4 border-b border-gray-200 bg-[#F5F5F5] flex-shrink-0">
                <div className="flex items-center">
                  <div className="w-10 h-10 bg-[#FFC107] rounded-full flex items-center justify-center">
                    <span className="text-gray-900 font-semibold">{selectedContact.name[0]}</span>
                  </div>
                  <div className="ml-3">
              ...
              {/* Messages Area */}
              <div className="flex-1 overflow-y-auto p-6 bg-[#E5DDD5]" style={{ 
