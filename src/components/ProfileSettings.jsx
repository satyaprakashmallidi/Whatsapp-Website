  ...
  const fetchSettings = async () => {
    ...
    try {
      const { data, error } = await supabase
        .from('User_details')
        .select('meta_access_token, meta_phone_number_id, meta_business_account_id, meta_app_id, webhook_token, secret_token, whatsapp_credentials_validated, credentials_last_validated_at')
        .eq('email', user.email)
        .single()
          ...
          <div className="p-6">
            ...
            <div className="mb-6 pb-6 border-b border-gray-200">
              ...
              <div className="space-y-3">
                ...
                <button
                  ...
                  className="mt-4 w-full flex items-center justify-center space-x-2 px-4 py-2 text-sm text-red-600 hover:text-red-700 hover:bg-red-50 rounded-lg border border-red-200 transition-colors font-medium"
                >
            ...
            <div className="mb-6 pb-6 border-b border-gray-200">
              ...
              <p className="text-sm text-gray-600 mb-4">
                Use this unique webhook URL to receive WhatsApp events from Meta
              </p>
              <div className="space-y-3">
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      value={settings.webhookToken
                        ? `${import.meta.env.VITE_SUPABASE_URL}/functions/v1/whatsapp-webhook?token=${settings.webhookToken}`
                        : 'Loading...'}
                      className="flex-1 px-4 py-2 bg-gray-50 border border-gray-300 rounded-lg text-gray-900 font-mono text-sm cursor-not-allowed"
                    />
                    <button
                      onClick={() => {
                        const url = `${import.meta.env.VITE_SUPABASE_URL}/functions/v1/whatsapp-webhook?token=${settings.webhookToken}`
                      ...
                      disabled={!settings.webhookToken}
                      className="px-4 py-2 bg-[#FFC107] text-gray-900 rounded-lg hover:bg-[#FFB300] transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                    >
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    This URL is permanent and unique to your account. Configure it in Meta Business Manager.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      type="password"
                      readOnly
                      value={settings.secretToken || 'Loading...'}
                      className="flex-1 px-4 py-2 bg-gray-50 border border-gray-300 rounded-lg text-gray-900 font-mono text-sm cursor-not-allowed password-black-dots"
                    />
                    <button
                      onClick={() => {
                        ...
                        showAlert({
                          title: 'Copied!',
                          message: 'Verify token copied to clipboard',
                          type: 'success'
                        })
                      }}
                      disabled={!settings.secretToken}
                      className="px-4 py-2 bg-[#FFC107] text-gray-900 rounded-lg hover:bg-[#FFB300] transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                    >
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" />
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Use this token when configuring webhooks in Meta Business Manager.
                  </p>
                </div>
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div className="text-sm text-blue-800">
                      ...
                      <ol className="list-decimal ml-4 space-y-1">
                        ...
                        <li>Go to <a href="https://business.facebook.com" target="_blank" rel="noopener noreferrer" className="underline hover:text-blue-600">Meta Business Manager</a></li>
                        <li>Navigate to WhatsApp → Configuration → Webhooks</li>
                        <li>Paste your webhook URL and the verify token shown above</li>
